...
Z([3,'cu-custom'])
Z([[2,'+'],[[2,'+'],[1,'height:'],[[2,'+'],[[7],[3,'CustomBar']],[1,'rpx']]],[1,';']])
Z([[4],[[5],[[5],[[5],[1,'cu-bar fixed round-bar tabbar aero']],[[2,'?:'],[[2,'!='],[[7],[3,'bgImage']],[1,'']],[1,'none-bg text-white bg-img'],[1,'']]],[[7],[3,'bgColor']]]])
Z([[2,'+'],[1,'background-color:#FFF3E2;'],[[7],[3,'style']]])
Z([3,'bar-shadow'])
Z([3,'width:100%;'])
Z([3,'flex padding-lr-xxl padding-bottom-xl padding-top-xl justify-between'])
Z([3,'bar-text'])
Z([3,'backText'])
Z([3,'more-button'])
Z([3,'aspectFit'])
Z([3,'../../static/icons/more.svg'])
Z([3,'padding-lr-lg'])
Z([3,'search-form round search'])
Z([3,'search-button'])
Z(z[10])
Z([3,'../../static/icons/search.svg'])
Z([1,false])
Z([3,'__e'])
Z(z[18])
Z([3,'search'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'background-color:#f3f3f3;font-family:Didact Gothic;display:-webkit-flex;-webkit-flex-direction:column;'])
Z([3,'__l'])
Z([1,true])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'bar flex justify-end'])
Z([3,'height:200rpx;'])
Z([3,'new-message-btn bg-white shadow-warp shadow margin-right-xl'])
Z([3,'__e'])
Z([3,'bar-button message-btn'])
Z([[4],[[5],[[4],[[5],[[5],[1,'tap']],[[4],[[5],[[4],[[5],[1,'newMessage']]]]]]]]])
Z([3,'aspectFit'])
Z([3,'../../static/icons/Note.svg'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'height:inherit;position:relative;'])
Z([3,'cu-bar tabbar bg-white foot round-bar'])
...
Z([3,'cuIcon-back text-bold'])
Z([3,'backText'])
Z([3,'content text-bold'])
Z([[2,'+'],[[2,'+'],[1,'top:'],[[2,'+'],[[7],[3,'StatusBar']],[1,'px']]],[1,';']])
Z([3,'content'])
Z([3,'cuIcon-info info-btn text-bold'])
Z([3,'right'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'margin-xl item padding-lg'])
Z([3,'flex item-middle justify-between'])
Z([3,'name-text text-bold '])
Z([3,'标题'])
Z([3,'time-text text-bold '])
Z([3,'5 min'])
Z([3,'item-end'])
Z([3,'content-text text-bold margin-top-sm'])
Z([3,'A man was saying must be true, but he did not need to say that he knows it.A man was saying must be true, but he did not need to say that he knows it.A man was saying must be true, but he did not need to say that he knows it.A man was saying must be true, but he did not need to say that he knows it.'])
...
(function(z){var a=11;function Z(ops){z.push(ops)}
Z([3,'background-color:#FEF2E2;font-family:Didact Gothic;'])
Z([3,'__l'])
Z([3,'1'])
Z([[4],[[5],[1,'backText']]])
Z([3,'backText'])
Z([3,'Notes'])
Z([3,'margin-top:192rpx;'])
Z([3,'index'])
Z([3,'item'])
Z([[7],[3,'messageItems']])
Z(z[7])
...
var x=['./colorui/components/search.wxml','./pages/basics/home.wxml','./pages/chat/index.wxml','./pages/component/bottom-bar.wxml','./pages/component/chat-bottom.wxml','./pages/component/cu-custom.wxml','./pages/component/home.wxml','./pages/component/message-item.wxml','./pages/home/index.wxml','./pages/plugin/home.wxml'];d_[x[0]]={}
...
_(aL,tM)
var eN=_mz(z,'input',['adjustPosition',17,'bindblur',1,'bindfocus',2,'confirmType',3,'data-event-opts',4,'placeholder',5,'placeholderClass',6,'style',7,'type',8],[],e,s,gg)
_(aL,eN)
_(lK,aL)
_(fE,lK)
_(oD,fE)
...
var z=gz$gwx_2()
var oP=_n('view')
var xQ=_mz(z,'scroll-view',['scrollY',-1,'class',0],[],e,s,gg)
var oR=_mz(z,'image',['class',1,'mode',1,'src',2],[],e,s,gg)
_(xQ,oR)
var fS=_n('view')
...
var aZ=_mz(z,'navigator',['navigateTo',-1,'class',9,'hoverClass',1,'style',2,'url',3],[],cW,oV,gg)
var t1=_n('view')
_rz(z,t1,'class',13,cW,oV,gg)
var e2=_oz(z,14,cW,oV,gg)
_(t1,e2)
_(aZ,t1)
var b3=_n('view')
_rz(z,b3,'class',15,cW,oV,gg)
var o4=_oz(z,16,cW,oV,gg)
_(b3,o4)
_(aZ,b3)
var x5=_n('text')
_rz(z,x5,'class',17,cW,oV,gg)
_(aZ,x5)
_(oX,aZ)
return oX
}
...
var z=gz$gwx_3()
var c8=_n('view')
_rz(z,c8,'style',0,e,s,gg)
var h9=_mz(z,'cu-custom',['bind:__l',1,'isBack',1,'style',2,'vueId',3,'vueSlots',4],[],e,s,gg)
var o0=_n('view')
_rz(z,o0,'slot',6,e,s,gg)
_(h9,o0)
var cAB=_n('view')
_rz(z,cAB,'slot',7,e,s,gg)
var oBB=_oz(z,8,e,s,gg)
_(cAB,oBB)
_(h9,cAB)
_(c8,h9)
var lCB=_mz(z,'chat-bottom',['bind:__l',9,'vueId',1],[],e,s,gg)
_(c8,lCB)
_(r,c8)
return r
}
...
var oHB=_mz(z,'image',['bindtap',3,'class',1,'data-event-opts',2,'mode',3,'src',4],[],e,s,gg)
_(bGB,oHB)
_(eFB,bGB)
_(tEB,eFB)
_(r,tEB)
...
var lQB=_mz(z,'view',['bindtap',6,'class',1,'data-event-opts',2],[],e,s,gg)
var aRB=_n('text')
_rz(z,aRB,'class',9,e,s,gg)
_(lQB,aRB)
var tSB=_n('slot')
_rz(z,tSB,'name',10,e,s,gg)
_(lQB,tSB)
_(oPB,lQB)
}
var eTB=_mz(z,'view',['class',11,'style',1],[],e,s,gg)
var bUB=_n('slot')
_rz(z,bUB,'name',13,e,s,gg)
_(eTB,bUB)
_(cOB,eTB)
var oVB=_n('view')
var xWB=_n('text')
...
var z=gz$gwx_7()
var cZB=_n('view')
var h1B=_mz(z,'scroll-view',['scrollY',-1,'class',0],[],e,s,gg)
...
var o0B=_mz(z,'navigator',['navigateTo',-1,'class',9,'hoverClass',1,'style',2,'url',3],[],t7B,a6B,gg)
var xAC=_n('view')
_rz(z,xAC,'class',13,t7B,a6B,gg)
var oBC=_oz(z,14,t7B,a6B,gg)
_(xAC,oBC)
_(o0B,xAC)
var fCC=_n('view')
_rz(z,fCC,'class',15,t7B,a6B,gg)
var cDC=_oz(z,16,t7B,a6B,gg)
_(fCC,cDC)
_(o0B,fCC)
var hEC=_n('text')
_rz(z,hEC,'class',17,t7B,a6B,gg)
_(o0B,hEC)
_(e8B,o0B)
return e8B
}
...
var hSC=_mz(z,'cu-custom',['bind:__l',1,'vueId',1,'vueSlots',2],[],e,s,gg)
var oTC=_n('view')
_rz(z,oTC,'slot',4,e,s,gg)
...
var x3C=_mz(z,'message-item',['bind:__l',11,'imgUrl',1,'vueId',2],[],eZC,tYC,gg)
_(b1C,x3C)
return b1C
}
lWC.wxXCkey=4
_2z(z,9,aXC,e,s,gg,lWC,'item','index','index')
_(cRC,oVC)
var o4C=_mz(z,'bottom-bar',['bind:__l',14,'vueId',1],[],e,s,gg)
_(cRC,o4C)
_(r,cRC)
return r
}
...
var z=gz$gwx_10()
var c6C=_n('view')
var h7C=_mz(z,'scroll-view',['scrollY',-1,'class',0],[],e,s,gg)
var o8C=_mz(z,'cu-custom',['bgImage',1,'bind:__l',1,'vueId',2,'vueSlots',3],[],e,s,gg)
var c9C=_n('view')
_rz(z,c9C,'slot',5,e,s,gg)
var o0C=_mz(z,'image',['mode',6,'src',1,'style',2],[],e,s,gg)
_(c9C,o0C)
_(o8C,c9C)
_(h7C,o8C)
var lAD=_n('view')
...
var oHD=_mz(z,'view',['bindtap',14,'class',1,'data-event-opts',2,'data-url',3,'style',4],[],bED,eDD,gg)
var fID=_n('view')
_rz(z,fID,'class',19,bED,eDD,gg)
var cJD=_oz(z,20,bED,eDD,gg)
_(fID,cJD)
_(oHD,fID)
_(oFD,oHD)
return oFD
...
aBD.wxXCkey=2
_2z(z,12,tCD,e,s,gg,aBD,'item','index','index')
_(h7C,lAD)
var hKD=_n('view')
...
__wxAppCode__['colorui/components/search.wxss']=setCssToHead([".",[1],"padding-lr-xxl { padding-left: ",[0,60],"; padding-right: ",[0,60],"; }\n.",[1],"search-button { width: ",[0,38],"; height: ",[0,38],"; margin-left: ",[0,60],"; }\n.",[1],"ph-text { font-size: ",[0,24],"; color: #403833; }\n.",[1],"cu-bar .",[1],"search-form { background-color: #FFFFFF; }\n.",[1],"round-bar {}\n.",[1],"bar-shadow { height: 100%; }\n.",[1],"search { padding-top: ",[0,44],"; padding-bottom: ",[0,44],"; color: #0081FF; }\n.",[1],"more-button { width: ",[0,55],"; height: ",[0,55],"; border-radius: ",[0,27],"; }\n.",[1],"bar-text { color: #403833; font-size: ",[0,55],"; font-weight: bold; }\n.",[1],"search-form { margin: 0 0; }\n.",[1],"more-button:active { background-color: #fff3e2; }\n",],undefined,{path:"./colorui/components/search.wxss"});    
__wxAppCode__['colorui/components/search.wxml']=$gwx('./colorui/components/search.wxml');
...
__wxAppCode__['pages/component/bottom-bar.wxss']=setCssToHead([".",[1],"bar { position: fixed; width: 100%; bottom: 0; z-index: 1024; text-align: center; }\n.",[1],"message-btn { margin-top: ",[0,38],"; }\n.",[1],"bg-purple-blue { background-image: -o-linear-gradient(225deg, #40d4e6, #6584fd); background-image: linear-gradient(225deg, #40d4e6, #6584fd); color: #ffffff; }\n.",[1],"action-new-message-btn { }\n.",[1],"new-message-btn { width: ",[0,140],"; height: ",[0,140],"; border-radius: 50%; top: ",[0,10],"; }\n.",[1],"new-message-blank { width: ",[0,160],"; height: ",[0,160],"; border-radius: 50%; position: relative; margin: auto; display: block; line-height: 1; background-color: #f3f3f3; }\n.",[1],"home-button { margin-left: ",[0,140],"; }\n.",[1],"bar-button { width: ",[0,60],"; height: ",[0,60],"; }\n.",[1],"my-button { margin-right: ",[0,140],"; }\n.",[1],"round-bar { border-radius: ",[0,70]," ",[0,70]," 0 0; background-color: #FFFFFF; }\n",],undefined,{path:"./pages/component/bottom-bar.wxss"});    
__wxAppCode__['pages/component/bottom-bar.wxml']=$gwx('./pages/component/bottom-bar.wxml');

__wxAppCode__['pages/component/chat-bottom.wxss']=setCssToHead([".",[1],"message-btn { margin-top: ",[0,38],"; }\n.",[1],"bg-purple-blue { background-image: -o-linear-gradient(225deg, #40d4e6, #6584fd); background-image: linear-gradient(225deg, #40d4e6, #6584fd); color: #ffffff; }\n.",[1],"action-new-message-btn { font-size: 11px; position: relative; -webkit-box-flex: 1; -webkit-flex: 1; -ms-flex: 1; flex: 1; text-align: center; padding: 0; display: block; height: auto; line-height: 1; margin: 0; overflow: initial; top: ",[0,-100],"; background-color: transparent; }\n.",[1],"new-message-btn { width: ",[0,140],"; height: ",[0,140],"; border-radius: 50%; position: relative; margin-left: ",[0,10],"; top: ",[0,10],"; display: block; line-height: 1; }\n.",[1],"new-message-blank { width: ",[0,160],"; height: ",[0,160],"; border-radius: 50%; position: relative; margin: auto; display: block; line-height: 1; background-color: #f3f3f3; }\n.",[1],"home-button { margin-left: ",[0,140],"; }\n.",[1],"bar-button { width: ",[0,60],"; height: ",[0,60],"; }\n.",[1],"my-button { margin-right: ",[0,140],"; }\n.",[1],"round-bar { border-radius: ",[0,70]," ",[0,70]," 0 0; }\n",],undefined,{path:"./pages/component/chat-bottom.wxss"});    
__wxAppCode__['pages/component/chat-bottom.wxml']=$gwx('./pages/component/chat-bottom.wxml');

__wxAppCode__['pages/component/cu-custom.wxss']=setCssToHead([".",[1],"cu-bar .",[1],"content { font-size: ",[0,40],"; }\n.",[1],"info-btn { margin-right: ",[0,56],"; font-size: ",[0,40],"; }\n.",[1],"cu-bar .",[1],"action:first-child { margin-left: ",[0,72],"; }\n.",[1],"body { background-color: #f3f3f3; font-size: 14px; color: #4a5467; font-family: Didact Gothic; }\n",],undefined,{path:"./pages/component/cu-custom.wxss"});    
__wxAppCode__['pages/component/cu-custom.wxml']=$gwx('./pages/component/cu-custom.wxml');
...
__wxAppCode__['pages/component/message-item.wxss']=setCssToHead([".",[1],"item { background-color: #fec674; border-radius: ",[0,50],"; height: ",[0,210],"; }\n.",[1],"time-text { color: #403833; font-size: ",[0,26],"; white-space: nowrap; }\n.",[1],"content-text { height: ",[0,65],"; font-size: ",[0,26],"; color: #403833; -webkit-line-clamp: 2; overflow: hidden; -o-text-overflow: ellipsis; text-overflow: ellipsis; line-height: ",[0,36],"; }\n.",[1],"name-text { color: #403833; font-size: ",[0,32],"; }\n.",[1],"item-middle { }\n.",[1],"item-end { margin-right: 0; padding-right: ",[0,0],"; }\n",],undefined,{path:"./pages/component/message-item.wxss"});    
__wxAppCode__['pages/component/message-item.wxml']=$gwx('./pages/component/message-item.wxml');

__wxAppCode__['pages/home/index.wxss']=setCssToHead(["body { background-color: #FEF2E2; }\n",],undefined,{path:"./pages/home/index.wxss"});    
